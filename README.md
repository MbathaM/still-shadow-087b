...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-shadow-087b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-shadow-087b
```

A live public deployment of this template is available at [https://still-shadow-087b.templates.workers.dev](https://still-shadow-087b.templates.workers.dev)
